...
REACHABLE_BY_EVERY_BACKEND=502
REACHABLE_NODE_ONLY=1387
...
| --- | ---: | ---: | ---: |
| `XNA_BACKING` | 1521 | 550 | 182 |
| `CNA_EXTENSION_BACKING` | 1871 | 1319 | 306 |
...
| `engine_layer.h` | 857 | 113 | 0 | 857 | 0 | 0 | 0 | 0 | 0 | 0 |
...
| `graphics.h` | 12 | 12 | 21 | 7 | 0 | 0 | 0 | 0 | 0 | 0 |
